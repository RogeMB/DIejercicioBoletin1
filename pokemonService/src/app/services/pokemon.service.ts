...
export class PokemonService {
  ...
  public getPokemon(index:any){
    return this.http.get(`${API_BASE_URL}/${index}`);
     //return this.http.get(API_BASE_URL.concat("/id"))
     // return this.http.get(`${API_BASE_URL}/id`); esta es la original con el id:string de parametro
  }
}
